...
/***
 * class responsible to provide services endpoints reading from
 * the endpoints.properties file
 */
public class EndPoints {
    ...
    public static String guiURL(){
        return endPoints.get("guiURI");
    }

    public static String dbDetails(){
        return endPoints.get("dbDetails");
    }
}
