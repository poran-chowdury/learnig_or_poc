#include "com_cinjava_poc_six_RegisterNativesHelloWorldJNI.h"
#include <iostream>
...
JNIEXPORT void JNICALL Java_com_cinjava_poc_six_RegisterNativesHelloWorldJNI_register (JNIEnv* env, jobject thsObject) {
