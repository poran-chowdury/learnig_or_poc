...
public class CustomAssertion {
	...
	/*
	 * public boolean assertFalse(boolean expression) { try {
	 * Assert.assertFalse(expression); test.log(Status.PASS, "Expression " +
	 * expression + " is true."); System.out.println("expression " +expression );
	 * return true; } catch (AssertionError e) { String path =
	 * snapshot((TakesScreenshot) driver); printError(e, path); return false; } }
	 */
