...
//import com.relevantcodes.extentreports.ExtentTest;
//import com.relevantcodes.extentreports.Status;
//public class TestCaseBase extends Thread{
public class TestCaseBase {
	...
	protected final String description = " This is a simple test from complex factory";
	...
	protected String csvFilesPath=System.getProperty("user.dir") + "/testdata/csvfiles";
...
//			Runtime.getRuntime().exec("taskkill /F /IM chromedriver.exe");
	...
	private void setDefaultTestData() {
		 ...
		 String s = this.getClass().getName(); String filename = ("testdata_" +
		 s.split("\\.")[s.split("\\.").length - 1] + ".properties");
		 log.info("Setting...filename=" + filename);
		TestData.load(filename);
		 
		//TestData.load(("testdata_" + ".csv"));
