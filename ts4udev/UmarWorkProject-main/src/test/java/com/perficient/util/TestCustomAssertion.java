...
public class TestCustomAssertion {
    ...
    public void setUp() throws Exception {
        try {
            ...
            testCase.setUpBrowser("chrome", "false", "0", "0");
            this.webDriver = testCase.getDriver();
            this.customAsserter = new CustomAssertion(webDriver, test);
        } catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void TestAssertTrue() {
        boolean testResult = customAsserter.assertTrue(true);
        Assert.assertTrue(testResult);
    }
    ...
    public void NegativeTestAssertTrue() {
        boolean testResult = customAsserter.assertTrue(false);
        Assert.assertFalse(testResult);
    }
